...
# -*- encoding: utf-8 -*-
'''
@File    :   multi_binary_cla_runner.py
@Author  :   Racle
@Version :   1.0
@Desc    :   None
'''
...
class MultiBinaryClaRunner(BaseRunner):
    def __init__(
        self,
        model_type,
        model_file,
    ...
    def evaluate(self, eval_df, output_dir, multi_label=True, verbose=True, silent=False, **kwargs):
